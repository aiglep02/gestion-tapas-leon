...
# Form implementation generated from reading ui file 'vistas/admin_usuarios.ui'
#
...
class Ui_AdminUsuarios(object):
    def setupUi(self, Dialog):
        ...
        self.CambiarRol = QtWidgets.QPushButton(self.groupBox)
        self.CambiarRol.setFont(font)
        self.CambiarRol.setObjectName("CambiarRol")
        self.horizontalLayout.addWidget(self.CambiarRol)
        ...
        self.BotonAyuda = QtWidgets.QPushButton(self.groupBox)
        self.BotonAyuda.setText("?")
        self.BotonAyuda.setFixedSize(30, 30)
        self.BotonAyuda.setFont(font)
        self.BotonAyuda.setObjectName("BotonAyuda")
        self.horizontalLayout.addWidget(self.BotonAyuda)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.CambiarRol.setText(_translate("Dialog", "Rol"))
